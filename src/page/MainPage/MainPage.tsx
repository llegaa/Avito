...
export function MainPage(){
    ...
    const {data:moviesRTK, isLoading, error} = moviesAPI.useFetchAllMoviesQuery({page: queryParam.page, countElement: queryParam.count, genre: queryParam.genre, country: queryParam.country, year: queryParam.year})
                    ...
                    (moviesRTK.docs.length!==0 ? (
                        <div ref={scrollRef} className={style.movies}>
                            ...
                            <div className={style.pages}>
                                <Page curPage={queryParam.page} allPages={moviesRTK.pages} setCurPage={changeParams('page')}/>
